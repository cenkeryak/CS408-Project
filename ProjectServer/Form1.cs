            ...
            try
            {
                ...
                if (userNames.Contains(clientUserName))
                {
                    ...
                    try
                    {
                        ...
                        richTextBoxEventLog.AppendText("NO sended to denied client " + "\n");
                    }
                    catch
                    {
                ...
                else
                {
                    ...
                    richTextBoxEventLog.AppendText("Username accepted: " + clientUserName + "\n");
                    ...
                    try
                    {
                        ...
                        richTextBoxEventLog.AppendText("OK sended to: " + clientUserName + "\n");
                    }
                    catch
                    {
                        richTextBoxEventLog.AppendText("There is a problem! Server could not send the message:" + messageToSend + "\n");
                    ...
                    lock (threadLock)
                    {
                        ...
                        if (clientUserName != null)
                        {
                            ...
                            if (spsSubs.Contains(clientUserName))
                            {
                                ...
                                string stringToSend = "sps101 " + clientUserName + " unsubscribed ";
                            ...
                            if (ifSubs.Contains(clientUserName))
                            {
                                ...
                                string stringToSend = "if100 " + clientUserName + " unsubscribed ";
            ...
            if (userRequest == "subscribe")
            {
                ...
                if (channelToSub == "sps101")
                {
                    if (!spsSubs.Contains(userName))
                    {
                        ...
                        richTextBoxEventLog.AppendText("Channel sub notification sent to sps101: " + stringToSend + "\n");
                ...
                else if (channelToSub == "if100")
                {
                    if (!ifSubs.Contains(userName))
                    {
                        ...
                        richTextBoxEventLog.AppendText("Channel sub notification sent to if100: " + stringToSend + "\n");
            ...
            else if (userRequest == "unsubscribe")
            {
                ...
                if (channelToUnSub == "sps101")
                {
                    if (spsSubs.Contains(userName))
                    {
                        ...
                        richTextBoxEventLog.AppendText("Channel unsub notification sent to sps101: " + stringToSend + "\n");
                    }
                }
                else if (channelToUnSub == "if100")
                {
                    if (ifSubs.Contains(userName))
                    {
                        ...
                        richTextBoxEventLog.AppendText("Channel unsub notification sent to if100: " + stringToSend + "\n");
                    }
                }
